...
interface AdditionalServiceHighlightsSectionProps {
  content?: {
    enabled?: boolean;
    title?: string;
...
export default function AdditionalServiceHighlightsSection({ content }: AdditionalServiceHighlightsSectionProps) {
  if (!content?.enabled) {
    return null;
  }
  ...
  return (
    <section id="additional-service-highlights" className={cn("relative", paddingClass)}>
